...
<h2>Your favourite Chinese Food in here..</h2>

<div id="chinese-food-container">
    <?php
    include 'connection.php';

    $sql_select = "SELECT * FROM chinese_food";
    $result = $conn->query($sql_select);

    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo '<div class="chinese-food-item">';
        ...
        echo "No Chinese food items found.";
    }
